...
class ImageUnderstandingPrompt(BasePrompt):
    def __init__(self, base64_image: str, image_format: str):
        ...
        self._prompt = {
            ...
            '任务步骤': {
                '图像解构': {
                    'step_1': '分析图像的风格 (可选类型有, <写实> <国漫立绘> <日漫立绘> <美漫立绘>)',
                ...
                '书名提取': {
                    'hint': '1. 在这个步骤/环节中不要提及具体的书名或文字内容, 你要做的是抽象与解构, 意在学习其可泛化的普适性特征.\n'
                            '2. 你只需要关注书名, 不要关注其他任何其他文字信息.',
                    'step_1': '详细解析[书名]的布局与字体风格(可能存在多种字体风格, 字体风格包括字体色彩设计与样式设计).'
                }
            },
            '输出规范': {
                '输出格式': 'json',
